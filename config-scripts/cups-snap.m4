...
AC_ARG_WITH(cups_control_slot, [  --with-cups-control-slot Name for cups-control slot as defined in snapcraft.yaml, only needed with --enable-snapped-cupsd, default=cups-control],
        CUPS_CONTROL_SLOT="$withval", CUPS_CONTROL_SLOT="cups-control")
